...
@section('content')
    <div class="row">
        ...
        <div class="col-md-3">Domena</div>
        <div class="col-md-2">Typ</div>
        <div class="col-md-2">Status</div>
        <div class="col-md-3">Notatka</div>
        <div class="col-md-2">Akcje</div>
        </div>
    @foreach($pages as $page)
        <div class="col-lg-12" style="padding-top:5px;">
        <div class="col-md-3"><a href="{{ action('PagesController@show',$page->id) }}">{{$page->domain->name}}</a></div>
        <div class="col-md-2">{{$page->type}}</div>
        <div class="col-md-2">{{$page->status}}</div>
        <div class="col-md-3">{{$page->note}}</div>
        <div class="col-md-2">
